...
# the difference between this version and 04 is the adjustment for the count of ngram appearance
# from previous analysis, we observe that stations repeat certain segments they have internally for different parts of the day
# e.g. local news and weather

# in order to get a better picture of the repetition of segments across different stations as desired, 
# we are getting the unique ngrams wrt to stations instead of segment
# before doing the ngram counts
library(magrittr)
library(dplyr)
library(tidytext)
library(dbscan)
